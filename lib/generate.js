...
const { log, warnText, infoText, succeedLog, errorLog } = require('./utils/log');
...
module.exports = async (tempName, newName, options) => {
    try {
        ...
        // 获取模板配置信息
        const tempConfig = await promptTempConfig(options, tempName, clientTempConfigs);
        // 收集生成配置信息
